...
export default function Confirm({ context, match }) {
  ...
  const [userAlreadyConfirmed, setUserAlreadyConfirmed] = useState([])
        ...
        <Row className='justify-content-md-center'>
          <Col xs md lg='auto'>
            <Alert variant='danger'>
              ...
              <p>
                Looks like we couldn't find you in our Database. Click the link below to sign up.
              </p>
              <hr />
        ...
        <Row className='justify-content-md-center'>
          <Col xs md lg='auto'>
            <Alert variant='success'>
              <Alert.Heading>{message}</Alert.Heading>
              <p>
                Yay! Your email is confirmed. Click the link below to go to your Profile or Home to
                browse categories.
              </p>
              <hr />
        ...
        <Row className='justify-content-md-center'>
          <Col xs md lg='auto'>
            <Alert variant='success'>
              ...
              <p>
                Our records indicate that your email is already confirmed. Congrats, your email is
                valid! Click the links below to view recommendations or view your profile.
              </p>
              <hr />
              <Alert.Link href='/' className='mb-0'>
                Home
